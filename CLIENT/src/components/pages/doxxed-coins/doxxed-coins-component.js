...
import {GET_DOXXED_COINS} from '../../../services/graphql'
...
export default function DoxxedCoins() {
    ...
    const {loading, data, fetchMore, networkStatus} = useQuery(GET_DOXXED_COINS, {
    ...
    return (
        <div className="coin-page">
            ...
            {networkStatus === 1  ? <div style={{width: '100%', minHeight: 450, textAlign: 'center'}}><CircularProgress/></div> :
                ...
                data?.Doxxed.length === 0 ? <p style={{color: '#5c5c5c', fontSize: 14, textAlign: 'center'}}>No listed coins found.&nbsp; 
